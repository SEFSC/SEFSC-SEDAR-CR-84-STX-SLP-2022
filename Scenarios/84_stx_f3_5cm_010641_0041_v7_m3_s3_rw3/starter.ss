...
#C file write time: 2024-10-29  07:00:18
datafile.dat
controlfile.ctl
...
-1 # min yr for sdreport outputs (-1 for styr); #_2010
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1744555932
