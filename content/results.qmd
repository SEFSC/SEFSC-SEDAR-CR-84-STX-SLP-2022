...
```{r}
#| label: tbl-corr
#| tbl-cap: "St. Croix stoplight parrotfish correlations between estimated parameters by . The table shows correlations greater than 0.9 or less than -0.9. Correlations values that are greater than 0.95 or less than -0.95 are shown in red."
