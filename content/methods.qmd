...
| Model Development | Code | Sequential modeling steps |
|-----------------|-------------|----------------------------------------------|
| Scenario inputs |	5cm_010641 | 01 - 41 centimeters, 5 cm bins; First bin is 10 cm |
| Initial steps	| ct	| model initialized with continuum tool (ct) scenario inputs |
|Initial steps	| m1	| ct modified for biology (adjust growth + hermaphroditism) |
| Initial steps	| m2	| m1 modified for continuous recruitment (4 settlement events) |
