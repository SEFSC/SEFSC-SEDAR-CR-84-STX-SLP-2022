...
```{r}
#| label: tbl-dq
#| tbl-cap: "St. Croix stoplight parrotfishderived quantities for unfished and initial spawning stock biomass in metric tons (mt) along with standard deviations (SD) and coeficient of variation (CV) by modeling scenario. CV is calcuated as the SD devided by the paramter estimate."
